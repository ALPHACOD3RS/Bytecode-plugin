...
private fun MainScreen(
    ...
    Box(modifier) {
        ...
        Button(
            onClick = {
                // Perform navigation directly here
                val intent = Intent(context, NetworkCallActivity::class.java)
...
//fun navigateToNetworkCallActivity() {
//    // This function should not be @Composable and should handle the context-related logic.
//    val context = LocalContext.current
//    val intent = Intent(context, NetworkCallActivity::class.java)
//    context.startActivity(intent)
//}
